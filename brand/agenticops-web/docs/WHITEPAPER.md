# AgenticOps & Chrysalis — Technical Whitepaper
...
**wisptools.io** (WISP-Management ecosystem, MIT-licensed) is cited as **production proof** of agent-assisted delivery at operational scale—multi-tenant telecom / ISP workflows—not as a merge of product identity with AgenticOps. It demonstrates the **same shipping discipline** that informed Chrysalis: agents in the loop, humans gating risk, production as the referee.
...
| Resource | URL |
|----------|-----|
| AgenticOps (marketing) | https://agenticop.io/ |
